...
class VoiceRecorder(private val mCallback: Callback) {
    ...
    companion object {
        ...
        private val CHANNEL: Int = android.media.AudioFormat.CHANNEL_IN_MONO
        private val ENCODING: Int = android.media.AudioFormat.ENCODING_PCM_16BIT
